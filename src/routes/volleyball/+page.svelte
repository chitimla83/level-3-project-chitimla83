        ...
        <div class="tile">
          <div class="tile is-parent is-vertical">
            <article class="tile is-child">
              <Image src="/volleyball2.png" alt="school volleyball" />
            </article>
            <article class="tile is-child">
              <Image src="/volleyball.png" alt="school volleyball" />
            </article>
          </div>
          <!-- end of tile -->
          <div class="column" />
          ...
          <div class="column">
            ...
            <p>Aoraki Volleyball - Thursday 23 March, Timaru</p>
            <br />
            <h2>UNIFORM</h2>
            <p>PE shorts, top provided, white socks, gymshoes</p>
          </div>
        </div>

        <h2>Volleyball</h2>
        <p>The Senior A Volleyball team competed at the Mainland Tournament in Christchurch recently. The team competed in Division 3 finishing 8th out of 16 teams, with 4 wins and 4 narrow losses. The girls played some amazing volleyball and it a great experience for them. Team - Mr Tom Wallis(coach), Natalie Whiteley, Isobel Sharp, Emily Shrimpton, Mary Hay, Mrs Anna Coleman(Manager), Laura Apperley, Koko Kubota, Zara Coleman and Madeline Dominikovich.</p>
        <br />
        <h2>Aoraki Volleyball</h2>
        <p>
